...
func main() {
	...
	// Is this a date only?
	d, err := time.Parse("01 January 2006", dateString)
	if err != nil {
		fmt.Println("Full:", d)
	...
	// Is this a date + time?
	d, err = time.Parse("02 January 2006 15:04:05", dateString)
	if err == nil {
		fmt.Println("Full:", d)
		fmt.Println("Date:", d.Day(), d.Month(), d.Year())
	...
	// Is this a data + time with month represented as a number?
	d, err = time.Parse("02 01 2006 15:04:05", dateString)
	if err == nil {
		fmt.Println("Full:", d)
		fmt.Println("Date:", d.Day(), d.Month(), d.Year())
		fmt.Println("Time:", d.Hour(), d.Minute(), d.Second())
